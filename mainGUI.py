...
def query_gemini_api(db_path, user_input):
    ...
    if contains_keywords(user_input, ACCEPTED_KEYWORDS):
        response = model.generate_content([f"{tone}. Search what you can and answer based on this query: {user_input} with the provided data. Limit up to 500 words", db_content])
