...
def query_gemini_api(csv_path, user_input):
    ...
    if "Not found" in response or "Unavailable" in response or "does not contain information" in response or "does not include information" in response or not response.strip():
